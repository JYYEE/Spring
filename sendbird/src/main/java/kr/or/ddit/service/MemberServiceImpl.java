...
public class MemberServiceImpl implements MemberService {
	...
	public void insertBook(BooksVO vo) {
		mapper.insertBooks(vo);
	}

	@Override
	public BooksVO selectOne() {
		return mapper.selectOne();
	}

	@Override
	public void insertBookManager(String book_no) {
		mapper.insertBookManager(book_no);
		
	}

	@Override
	public void insertPaperBook(BooksVO vo) {
		mapper.insertPaperBook(vo);
