...
public class ValidationController {
	 ...
	 *  4. 에러를 받은 BindingResult를 설정한다. (컨트롤러 메서드 내에 설정한다.)
	 */
	...
	public String registerValidatedFormResult(@Validated Member member, BindingResult result) {
		// @Validated : 들어온 입력값 검증하도록 만드는 어노테이션
	...
	/*
	 * 4. 중첩된 자바빈즈 입력값 검증
	 * - 중첩된 자바빈즈와 자바빈즈의 컬렉션에서 정의한 프로퍼티에 대해 입력값을 검증 할 때는 @Valid를 지정한다.
	 * 
