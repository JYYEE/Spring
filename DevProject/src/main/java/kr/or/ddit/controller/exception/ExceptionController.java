...
public class ExceptionController {
	 ...
	 * 		- B. 수정화면 생성하고 뷰 파일에서 수정 진행할 때 예외 발생ㅇ
	 * 		- C. 삭제할 때, 매핑 파일에서 예외 발생
	 * 		- D. 존재하지 않는 게시물을 존재할 때, 사용자가 정의한 예외 발생
	 * 		- E. 존재하지 않는 페이지 URL요청시 예외 발생
	 * 
	 * 		1-3) 예외 처리 불가 기준
	 ...
	 * 
	 * 		예외 처리 방법
	 * 		- 입력값 검증 기능의 활성화화 BindingResult 정의
