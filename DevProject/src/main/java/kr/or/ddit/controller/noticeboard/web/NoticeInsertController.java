...
//		// 파일을 업로드할 대상
//		String uploaderFolder = "D:\\A_TeachingMaterial\\6.JspSpring\\02.SPRING2\\workspace_spring2\\DevProject\\src\\main\\webapp\\resources\\upload";
//		// 파일 객체 꺼내오기
//		MultipartFile[] boFile = noticeVO.getBoFile();
//		// 파일 배열객체로부터 파일을 하나씩 꺼내오자
...
//			File saveFile = new File(uploaderFolder, multipartFile.getOriginalFilename());
//			
//			// 연/월/일  폴더 생성
//			
//			// UUID 처리 (파일명 중복 방지)
...
//			}
//		}
//		// insert/update/delete의 경우 returnType="int" 생략
